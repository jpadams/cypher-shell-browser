...
func (m HelpModel) View() string {
	...
	sections := []string{
		...
		helpLine("t", "Toggle shape tree (rows collapsed by shape)"),
		helpLine("Tab / ⇧Tab", "Step through the rows behind a tree line"),
		helpLine("m/c", "Toggle MERGE/CREATE prefix (rows view)"),
